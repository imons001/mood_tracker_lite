...
//trigger controller import
import '../controllers/trigger_controller.dart';
import '../helpers/trigger_data.dart';
//trigger helper import

//showTriggerSheet function
Future<void> showTriggerSheet({
  required BuildContext context,
  required TriggerController controller,
  required String preselectedEmoji,
  required Future<void> Function() onSaved,
}) async {
  final match = triggers.firstWhere(
    (t) => t['emoji'] == preselectedEmoji,
    orElse: () => triggers.first,
  );
//final strings emojis labels and colors
...
//  required parameters: context, controller, preselectedEmoji, onSaved
//  find matching trigger from triggers list using preselectedEmoji
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Optional note (triggers, context, etc.)",
                        hintStyle:
